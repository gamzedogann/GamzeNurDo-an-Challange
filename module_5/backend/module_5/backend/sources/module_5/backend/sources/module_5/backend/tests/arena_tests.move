...
fun test_battle_cross_user() {
    ...
    // SENDER creates a hero and battle place (Power 7500)
    {
        hero::create_hero(
            b"Kostas".to_string(),
    ...
    // RECIPIENT creates a stronger hero (Power 8500)
    {
        hero::create_hero(
            b"Adeniyi".to_string(),
    ...
    // RECIPIENT (8500) battles SENDER's warrior (7500) -> RECIPIENT WINS
    {
        let hero = ts::take_from_sender<Hero>(&scenario);
